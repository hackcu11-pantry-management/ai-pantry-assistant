...
const PizzaImageLoadingScreen = () => {
  ...
  const [loadingText, setLoadingText] = useState('Finding delicious recipes for you...');
  ...
  const slices = Array(8).fill(0).map((_, i) => {
    ...
    <div className="loading-container">
      <div className="pizza-container">
        ...
        {slices.map((slice) => {
          ...
          const translateX = isRemoved ? Math.cos(radians) * slice.pullDistance : 0;
          const translateY = isRemoved ? Math.sin(radians) * slice.pullDistance : 0;
